...
public abstract class TableDefinitionParser extends DefinitionParser {
    ...
    private static Set<String> illegalLanguageAlias = CollectionUtils.asSet(Constants.BUILTIN_TYPES, "i", "I", "index", "u", "U", "unique", "o", "O", "optional", "ref", "lang", "min", "max");
    ...
    private class ExtDefinitionParser extends XmlDefinitionParser {
        ...
        protected FieldDefinition parseFieldDefinition(ClassDefinition classDefinition, Element fieldElement, int indexInParent) {
            if (classDefinition instanceof ConfigDefinition) {
                ...
                return super.parseFieldDefinition(classDefinition, fieldElement, indexInParent);
            }
        }
