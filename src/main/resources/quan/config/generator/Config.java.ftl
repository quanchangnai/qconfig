...
<#list selfFields as field>
    ...
    <#elseif field.timeType>
        this.${field.name}$Str = json.getOrDefault(<@fieldName field/>, "").toString();
        <#if field.type=="date">
        this.${field.name}= ${dn("ConfigConverter")}.parseDate(this.${field.name}$Str);
        <#elseif field.type=="time">
        this.${field.name} = ${dn("ConfigConverter")}.parseTime(this.${field.name}$Str);
        <#else>
        this.${field.name} = ${dn("ConfigConverter")}.parseDateTime(this.${field.name}$Str);
        </#if>
